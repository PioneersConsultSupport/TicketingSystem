    ...
    this.teamMembers = [
      {
        ...
        description:
          "I'm the company founder, built the team, supervised the organization strategic direction, and insure qualitative delivery.",
      ...
      },
      {
        ...
        description:
          'Responsible for overseeing the smooth operation of the office and ensuring that all administrative tasks are completed efficiently.',
      ...
      },
      {
        ...
        description:
          'Business understating, Solution architect, and quality assurance.',
      ...
      },
      {
        ...
        description:
          'Responsible for designing, developing, and maintaining high-quality software solutions. implement scalable and efficient applications.',
      ...
      },
      {
        ...
        description:
          'A skilled accountant specializing for managing financial records,handling accounts payable and receivable, and ensuring compliance with financial regulations.',
        twitterUrl: null,
        facebookUrl: null,
        instagramUrl: null,
        linkedInUrl: null,
      ...
      },
      {
        ...
        description:
          'Supports clients in optimizing supply chain processes, ensuring efficient operations and seamless integration of ERP solutions.',
      ...
      },
      {
        ...
        role: 'Senior Technical Consultant',
        description:
          'Expertise in software design, development, and testing to create innovative and effective solutions for our clients.',
